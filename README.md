...
I am an **Information Systems** student at the Goiás State University (UEG), passionate about technology and focused on building a solid career in **Back-end Development**.
...
<div align="left">
  ...
  <img src="https://img.shields.io/badge/Bizagi_Modeler-0052CC?style=for-the-badge" />
</div>
...
-  Mastering **C++** for Competitive Programming and **LeetCode**.
-  Deepening my expertise in the **Java** ecosystem, focusing on **Spring Boot**.
-  Advancing in **Ethical Hacking** and **Linux** through [OverTheWire](https://overthewire.org/wargames/), [TryHackMe](https://tryhackme.com/), and [Hack The Box](https://www.hackthebox.com/).
-  Expanding my Full-Stack development foundations via [The Odin Project](https://www.theodinproject.com/).
...
Minha jornada acadêmica me proporcionou uma base sólida em lógica e algoritmos, principalmente com a linguagem `C`, onde me aprofundei em Estruturas de Dados como Árvores Binárias e Grafos. Ao mesmo tempo, estou aplicando esse conhecimento em projetos práticos com `Java` e explorando o mundo da segurança ofensiva como um hobby.
...
- Dominando **C++** para Programação Competitiva e **LeetCode**.
- Aprofundando meus conhecimentos no ecossistema **Java**, com foco em **Spring Boot**.
- Avançando em **Ethical Hacking** e **Linux** através de plataformas como [OverTheWire](https://overthewire.org/wargames/), [TryHackMe](https://tryhackme.com/) e [Hack The Box](https://www.hackthebox.com/).
- Expandindo minha base de desenvolvimento Full-Stack através do [The Odin Project](https://www.theodinproject.com/).
...
* **Segurança Cibernética:** Um hobby e interesse constante, com foco em análise de vulnerabilidades, Ethical Hacking e Bug Bounty.
* **IA & Machine Learning:** Uma área que estou começando a explorar e pela qual tenho grande interesse.
